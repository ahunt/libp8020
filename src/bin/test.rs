...
fn main() {
    ...
    let Some(test_config) = load_all_builtin_configs()
        .into_iter()
        .find(|config| config.short_name == *protocol_name)
    else {
